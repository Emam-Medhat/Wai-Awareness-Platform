...
<div class="mobile-drawer" :class="{ open: mobileOpen }">
    ...
    <div class="drawer-logo">
      <div style="display: flex; align-items: center; gap: 0.75rem;">
        <div style="width: 36px; height: 36px;">
          <img src="<?php echo e(asset('images/wa3y-logo.png')); ?>" alt="وعي" style="width: 100%; height: 100%; object-fit: contain;">
        </div>
        <div>
          وعي
  ...
  <div class="drawer-body">
    ...
    <?php if(auth()->guard()->check()): ?>
      <?php if(auth()->user()->isAdmin()): ?>
        <a href="<?php echo e(route('admin.dashboard')); ?>" class="drawer-link">
  ...
  <div class="drawer-foot">
    <?php if(auth()->guard()->guest()): ?>
      <a href="<?php echo e(route('login')); ?>" class="drawer-login">تسجيل الدخول</a>
      <a href="<?php echo e(route('register')); ?>" class="drawer-join">انضم الينا</a>
    <?php else: ?>
      <div class="drawer-user-info">
        <div class="drawer-user-avatar"><?php echo e(substr(auth()->user()->first_name, 0, 1)); ?></div>
        <div class="drawer-user-details">
          <div class="drawer-user-name"><?php echo e(auth()->user()->first_name); ?> <?php echo e(auth()->user()->last_name); ?></div>
          <div class="drawer-user-role"><?php echo e(auth()->user()->role == 'admin' ? 'مدير' : (auth()->user()->role == 'campaign_manager' ? 'مدير حملات' : 'مستخدم')); ?></div>
        </div>
      </div>
    <?php endif; ?>
  </div>
  ...
  <div class="nav-glass">
    <div class="nav-inner">
      ...
      <a href="<?php echo e(route('home')); ?>" class="nav-logo">
        <div class="logo-icon">
          <img src="<?php echo e(asset('images/wa3y-logo.png')); ?>" alt="وعي" style="width: 100%; height: 100%; object-fit: contain; filter: drop-shadow(0 4px 12px rgba(45,94,58,0.35));">
        </div>
      ...
      <ul class="nav-links">
        ...
        <li class="dropdown-wrap" x-data="{ open: false }" x-cloak>
          <button class="nav-link <?php echo e(request()->routeIs('articles.*') ? 'active' : ''); ?>" :class="{ active: open }" @click="open = !open" @click.outside="open = false">
          ...
          <div class="mega-dropdown" :class="open ? 'visible-dd' : 'hidden-dd'">
            ...
            <div class="dd-items">
              <a href="<?php echo e(route('articles')); ?>" class="dd-item">
              ...
              <a href="<?php echo e(route('articles', ['category' => 'psychology'])); ?>" class="dd-item">
              ...
              <a href="<?php echo e(route('articles', ['category' => 'addiction'])); ?>" class="dd-item">
        ...
        <!-- الفيديوهات dropdown -->
        <li class="dropdown-wrap" x-data="{ open: false }" x-cloak>
          <button class="nav-link <?php echo e(request()->routeIs('videos.*') ? 'active' : ''); ?>" :class="{ active: open }" @click="open = !open" @click.outside="open = false">
          ...
          <div class="mega-dropdown" :class="open ? 'visible-dd' : 'hidden-dd'">
            ...
            <div class="dd-items">
              <a href="<?php echo e(route('videos')); ?>" class="dd-item">
              ...
              <a href="<?php echo e(route('videos', ['category' => 'psychology'])); ?>" class="dd-item">
        ...
        <!-- المكتبة dropdown -->
        <li class="dropdown-wrap" x-data="{ open: false }" x-cloak>
          <button class="nav-link <?php echo e(request()->routeIs('books.*') ? 'active' : ''); ?>" :class="{ active: open }" @click="open = !open" @click.outside="open = false">
          ...
          <div class="mega-dropdown" style="min-width:320px" :class="open ? 'visible-dd' : 'hidden-dd'">
            ...
            <div class="dd-items">
              <a href="<?php echo e(route('books')); ?>" class="dd-item">
              ...
              <?php if($categories->count() > 0): ?>
                ...
                <a href="<?php echo e(route('categories.show', $category)); ?>" class="dd-item">
                  <div class="dd-item-icon" style="background:linear-gradient(135deg,<?php echo e($category->color ?? '#2D5E3A'); ?>,<?php echo e($category->color ?? '#3A7D6E'); ?>)">
                    <i class="<?php echo e($category->icon ?? 'bi bi-book'); ?>"></i>
                  </div>
                  <div class="dd-item-text">
                    <strong><?php echo e($category->name); ?></strong>
                    <span><?php echo e(\App\Models\Book::published()->where('category', $category->slug)->count()); ?> كتاب</span>
                  </div>
                  <i class="bi bi-chevron-left dd-item-arrow"></i>
                </a>
        ...
        <!-- الأقسام dropdown -->
        <li class="dropdown-wrap" x-data="{ open: false }" x-cloak>
          <button class="nav-link <?php echo e(request()->routeIs('sections') ? 'active' : ''); ?>" :class="{ active: open }" @click="open = !open" @click.outside="open = false">
          ...
          <div class="mega-dropdown" style="min-width:360px" :class="open ? 'visible-dd' : 'hidden-dd'">
            ...
            <div class="dd-items" style="display:grid;grid-template-columns:1fr 1fr;gap:0.2rem;">
              ...
              <a href="<?php echo e(route('future-message.index')); ?>" class="dd-item" style="padding:0.65rem 0.75rem;">
              ...
              <a href="<?php echo e(route('ai-assistant')); ?>" class="dd-item" style="padding:0.65rem 0.75rem;">
        ...
        <li><a href="<?php echo e(route('about')); ?>" class="nav-link <?php echo e(request()->routeIs('about') ? 'active' : ''); ?>"><i class="bi bi-info-circle icon-main"></i> عن وعي</a></li>
        <li><a href="<?php echo e(route('guide')); ?>" class="nav-link <?php echo e(request()->routeIs('guide') ? 'active' : ''); ?>"><i class="bi bi-book icon-main"></i> دليل وعي</a></li>
        <li><a href="<?php echo e(route('contact')); ?>" class="nav-link <?php echo e(request()->routeIs('contact') ? 'active' : ''); ?>"><i class="bi bi-envelope icon-main"></i> تواصل معنا</a></li>
      </ul>
      ...
      <div class="nav-actions">
        ...
        <?php if(auth()->guard()->guest()): ?>
          <div style="display:flex;gap:0.6rem;align-items:center">
            <a href="<?php echo e(route('login')); ?>" class="btn-nav-login"><i class="bi bi-box-arrow-in-right"></i> تسجيل الدخول</a>
            <a href="<?php echo e(route('register')); ?>" class="btn-nav-join"><i class="bi bi-person-plus-fill"></i> انضم الينا</a>
          </div>
        <?php endif; ?>
        ...
        <?php if(auth()->guard()->check()): ?>
          ...
          <?php if(auth()->user()->isAdmin()): ?>
            <a href="<?php echo e(route('admin.dashboard')); ?>" class="btn-nav-admin">
          ...
          <div class="dropdown-wrap" x-data="{ open: false }" x-cloak>
            <button class="user-menu-btn" @click="open = !open" @click.outside="open = false">
              <div class="user-avatar"><?php echo e(substr(auth()->user()->first_name, 0, 1)); ?></div>
              <div class="user-info">
                <span class="user-name"><?php echo e(auth()->user()->first_name); ?> <?php echo e(auth()->user()->last_name); ?></span>
                <span class="user-role"><?php echo e(auth()->user()->role == 'admin' ? 'مدير' : (auth()->user()->role == 'campaign_manager' ? 'مدير حملات' : 'مستخدم')); ?></span>
              </div>
            ...
            <div class="mega-dropdown user-dropdown" :class="open ? 'visible-dd' : 'hidden-dd'">
              <div class="user-dd-header">
                <div class="user-dd-avatar"><?php echo e(substr(auth()->user()->first_name, 0, 1)); ?></div>
                <div class="user-dd-info">
                  <div class="name"><?php echo e(auth()->user()->full_name); ?></div>
                  <span class="role"><?php echo e(get_user_role_name(auth()->user()->role)); ?></span>
                </div>
              </div>
              <div class="dd-items">
                <a href="<?php echo e(route('profile.show')); ?>" class="dd-item">
                ...
                <a href="<?php echo e(route('future-message.index')); ?>" class="dd-item">
                ...
                <a href="<?php echo e(route('ai-assistant')); ?>" class="dd-item">
                ...
                <?php if(auth()->user()->isAdmin()): ?>
                  <a href="<?php echo e(route('admin.dashboard')); ?>" class="dd-item">
                ...
                <?php if(auth()->user()->isCampaignManager()): ?>
                  <a href="<?php echo e(route('community.index')); ?>" class="dd-item">
...
</html><?php /**PATH D:\saieed\وعي\resources\views\components\navbar.blade.php ENDPATH**/ ?>