<?php $__env->startSection('title', 'المكتبة'); ?>
  ...
  <div class="container position-relative" style="z-index:2">
    <div class="text-center">
      ...
      <div class="bp-stats d-flex flex-wrap justify-content-center gap-3">
        ...
        <?php $__currentLoopData = $bstats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bs): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="bp-stat">
          <div class="bp-stat-ico" style="background:<?php echo e($bs['bg']); ?>"><i class="bi <?php echo e($bs['i']); ?>"></i></div>
          <div>
            <div class="bp-stat-num"><?php echo e($bs['n']); ?></div>
            <div class="bp-stat-lbl"><?php echo e($bs['l']); ?></div>
          </div>
        </div>
  ...
  <aside class="bp-sidebar">
    <div class="filter-panel">
      <div class="filter-head">
        ...
        <?php if(request()->hasAny(['search','category','language','author_type'])): ?>
        <a href="<?php echo e(route('books')); ?>" class="filter-clear-all">
      ...
      <div class="filter-body">
        <form method="GET" action="<?php echo e(route('books')); ?>" id="filterForm">

          
          <?php if(request()->hasAny(['search','category','language','author_type'])): ?>
          <div class="f-chips">
            <?php if(request('search')): ?>
            <span class="f-chip"><?php echo e(Str::limit(request('search'),14)); ?><span class="f-chip-x" onclick="rmFilter('search')">×</span></span>
            <?php endif; ?>
            <?php $__currentLoopData = (array)request('category',[]); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cv): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php $cl=['psychology'=>'علم النفس','addiction'=>'الإدمان','relationships'=>'العلاقات','self_development'=>'التطوير الذاتي','family'=>'الأسرة'][$cv]??$cv ?>
            <span class="f-chip"><?php echo e($cl); ?><span class="f-chip-x" onclick="rmArr('category','<?php echo e($cv); ?>')">×</span></span>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            <?php $__currentLoopData = (array)request('language',[]); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lv): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <span class="f-chip"><?php echo e($lv==='ar'?'عربي':'English'); ?><span class="f-chip-x" onclick="rmArr('language','<?php echo e($lv); ?>')">×</span></span>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
          </div>
          <?php endif; ?>
          ...
          <div class="f-section">
            ...
            <?php $fCats=['psychology'=>'علم النفس','addiction'=>'الإدمان','relationships'=>'العلاقات','self_development'=>'التطوير الذاتي','family'=>'الأسرة والطفل'] ?>
            <?php $__currentLoopData = $fCats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fv=>$fl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <label class="f-check">
              <input type="checkbox" name="category[]" value="<?php echo e($fv); ?>" <?php echo e(in_array($fv,(array)request('category',[]))?'checked':''); ?>>
              <span class="f-check-label">
                <span class="f-check-box"></span><?php echo e($fl); ?>

              </span>
              <span class="f-cnt"><?php echo e(\App\Models\Book::published()->where('category',$fv)->count()); ?></span>
            </label>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
          </div>
          ...
          <div class="f-section">
            ...
            <?php $__currentLoopData = ['ar'=>'عربي','en'=>'English']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lv=>$ll): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <label class="f-check">
              <input type="checkbox" name="language[]" value="<?php echo e($lv); ?>" <?php echo e(in_array($lv,(array)request('language',[]))?'checked':''); ?>>
              <span class="f-check-label">
                <span class="f-check-box"></span><?php echo e($ll); ?>

              </span>
              <span class="f-cnt"><?php echo e(\App\Models\Book::published()->where('language',$lv)->count()); ?></span>
            </label>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
          </div>
          ...
          <div class="f-section" style="margin-bottom:1.4rem">
            ...
            <?php $__currentLoopData = ['doctor'=>'طبيب','psychologist'=>'أخصائي نفسي','other'=>'مؤلف عام']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $av=>$al): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <label class="f-check">
              <input type="checkbox" name="author_type[]" value="<?php echo e($av); ?>" <?php echo e(in_array($av,(array)request('author_type',[]))?'checked':''); ?>>
              <span class="f-check-label"><span class="f-check-box"></span><?php echo e($al); ?></span>
            </label>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
          </div>
          ...
          <?php if(request()->hasAny(['search','category','language','author_type'])): ?>
          <a href="<?php echo e(route('books')); ?>" class="f-reset d-flex"><i class="bi bi-arrow-clockwise"></i> مسح الكل</a>
          <?php endif; ?>
  ...
  <main class="bp-main">
    ...
    <div class="results-bar" data-sr="up">
      <div class="results-info">
        ...
        <strong><?php echo e($books->total()); ?></strong> كتاب
        <?php if(request()->hasAny(['search','category','language','author_type'])): ?>
      ...
      <div class="sort-wrap">
        ...
        <select class="sort-sel" name="sort" form="filterForm" onchange="document.getElementById('filterForm').submit()">
          <option value="latest"    <?php echo e(request('sort','latest')==='latest'   ?'selected':''); ?>>الأحدث</option>
          <option value="popular"   <?php echo e(request('sort')==='popular'           ?'selected':''); ?>>الأكثر مشاهدة</option>
          <option value="downloads" <?php echo e(request('sort')==='downloads'         ?'selected':''); ?>>الأكثر تحميلاً</option>
        </select>
      </div>
    </div>
    ...
    <?php if(!request()->hasAny(['search','category','language','author_type'])): ?>
      ...
      <?php if(isset($featuredBook) && $featuredBook): ?>
      <div class="feat-book" data-sr="up">
        <div class="row g-0">
          <div class="col-md-5">
            <div class="feat-img" style="min-height:280px">
              <?php if($featuredBook->cover_image): ?>
                <img src="<?php echo e(asset('storage/'.$featuredBook->cover_image)); ?>" alt="<?php echo e($featuredBook->title); ?>">
              <?php else: ?>
              ...
              <?php if($featuredBook->category): ?><span class="feat-cat"><?php echo e($featuredBook->category_label); ?></span><?php endif; ?>
              <span class="feat-lang"><?php echo e($featuredBook->language==='ar'?'عربي':'English'); ?></span>
            </div>
          </div>
          <div class="col-md-7">
            <div class="feat-body">
              <div class="feat-title"><?php echo e($featuredBook->title); ?></div>
              <?php if($featuredBook->description): ?><p class="feat-desc"><?php echo e(Str::limit($featuredBook->description,200)); ?></p><?php endif; ?>
              <div class="feat-meta">
                <?php if($featuredBook->pages): ?><span class="feat-meta-item"><i class="bi bi-file-text"></i> <?php echo e($featuredBook->pages); ?> صفحة</span><?php endif; ?>
                <span class="feat-meta-item"><i class="bi bi-eye"></i> <?php echo e(number_format($featuredBook->views??0)); ?></span>
                <span class="feat-meta-item"><i class="bi bi-download"></i> <?php echo e(number_format($featuredBook->download_count??0)); ?></span>
              </div>
              <div class="feat-author">
                <div class="feat-av"><?php echo e(mb_substr($featuredBook->author_name,0,1)); ?></div>
                <div>
                  <div class="feat-an"><?php echo e($featuredBook->author_name); ?></div>
                  <div class="feat-ar"><?php echo e(['doctor'=>'طبيب','psychologist'=>'أخصائي نفسي'][$featuredBook->author_type??'']??'مؤلف'); ?></div>
                </div>
              </div>
              <div class="feat-btns">
                <a href="<?php echo e(route('books.show',$featuredBook->slug??$featuredBook->id)); ?>" class="btn-pri"><i class="bi bi-book-half"></i> قراءة الآن</a>
                <?php if($featuredBook->pdf_file): ?>
                <a href="<?php echo e(route('books.download',$featuredBook->slug??$featuredBook->id)); ?>" class="btn-out"><i class="bi bi-download"></i> تحميل PDF</a>
                <?php endif; ?>
              </div>
            </div>
          </div>
      ...
      <?php $__currentLoopData = $catSections; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cs): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <?php $catBooks=\App\Models\Book::published()->where('category',$cs['slug'])->take(6)->get() ?>
      <?php if($catBooks->count()>0): ?>
      <div class="mb-5" data-sr="up">
        <div class="cat-hd">
          <div class="cat-hd-left">
            <div class="cat-hd-ico" style="background:<?php echo e($cs['bg']); ?>"><i class="bi <?php echo e($cs['ico']); ?>"></i></div>
            <div>
              <div class="cat-hd-name"><?php echo e($cs['name']); ?></div>
              <div class="cat-hd-cnt"><?php echo e(\App\Models\Book::published()->where('category',$cs['slug'])->count()); ?> كتاب</div>
            </div>
          </div>
          <a href="<?php echo e(route('books',['category'=>$cs['slug']])); ?>" class="cat-hd-link">
            عرض الكل <i class="bi bi-arrow-left"></i>
          </a>
        </div>
        <div class="row g-3">
          <?php $__currentLoopData = $catBooks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bi=>$book): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <div class="col-sm-6 col-xl-4" data-sr="up" data-sr-d="<?php echo e(($bi%3)+1); ?>">
            <?php echo $__env->make('partials.book-card', ['book'=>$book, 'idx'=>$bi], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
          </div>
          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
      </div>
    ...
    <?php else: ?>
      ...
      <div class="bp-empty" data-sr="zoom">
        ...
        <a href="<?php echo e(route('books')); ?>" class="btn-pri" style="font-size:.84rem;padding:.6rem 1.5rem"><i class="bi bi-arrow-clockwise"></i> عرض الكل</a>
      </div>
      <?php else: ?>
      <div class="row g-3">
        <?php $__currentLoopData = $books; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bi=>$book): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="col-sm-6 col-xl-4" data-sr="up" data-sr-d="<?php echo e(($bi%3)+1); ?>">
          <?php echo $__env->make('partials.book-card', ['book'=>$book, 'idx'=>$bi], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
        </div>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
      ...
      <div class="bp-pages"><?php echo e($books->withQueryString()->links()); ?></div>
      <?php endif; ?>
      <?php endif; ?>
      ...
      <div class="cat-hd">
        <div class="cat-hd-left">
          ...
          <div>
            ...
            <div class="cat-hd-cnt"><?php echo e($books->total()); ?> كتاب</div>
          </div>
        </div>
      </div>
      <div class="row g-3">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\saieed\وعي\resources\views\books\index.blade.php ENDPATH**/ ?>