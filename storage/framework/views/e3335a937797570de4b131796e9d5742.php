...
<?php $__env->startSection('title', 'تعديل الكتاب: ' . $book->title); ?>
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-md-8">
                ...
                <p class="lead mb-0">
                    تعديل بيانات الكتاب: <strong><?php echo e($book->title); ?></strong>
                </p>
            </div>
            <div class="col-md-4 text-end">
                <a href="<?php echo e(route('admin.books.show', $book->id)); ?>" class="btn btn-light btn-lg me-2">
...
<div class="stats-grid">
    <div class="row">
        <div class="col-md-3 mb-3">
            <div class="stat-item">
                <div class="stat-number"><?php echo e(number_format($book->views)); ?></div>
                <div class="stat-label">المشاهدات</div>
            </div>
                                <div class="col-md-3 mb-3">
            <div class="stat-item">
                <div class="stat-number"><?php echo e(number_format($book->download_count)); ?></div>
                <div class="stat-label">التحميلات</div>
            </div>
        </div>
        <div class="col-md-3 mb-3">
            <div class="stat-item">
                <div class="stat-number"><?php echo e($book->rating); ?>/5</div>
                <div class="stat-label">التقييم</div>
            </div>
        </div>
        <div class="col-md-3 mb-3">
            <div class="stat-item">
                <div class="stat-number"><?php echo e($book->rating_count); ?></div>
...
<div class="row">
    <div class="col-12">
        <div class="d-flex gap-3 justify-content-center">
            ...
            <a href="<?php echo e(route('admin.books.show', $book->id)); ?>" class="btn btn-info btn-lg">
                <i class="fas fa-eye me-2"></i> عرض
            </a>
        </div>
    </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\saieed\وعي\resources\views\admin\books\edit.blade.php ENDPATH**/ ?>