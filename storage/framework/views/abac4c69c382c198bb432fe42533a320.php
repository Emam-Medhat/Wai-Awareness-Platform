        ...
        <div class="hero-content-wrapper" style="max-width: 600px;">
          ...
          <div class="hero-actions mb-6">
            <div class="actions-grid" style="display: grid; grid-template-columns: 1fr 1fr; gap: 1rem; margin-bottom: 1.5rem;">
              <a href="<?php echo e(route('sections')); ?>" 
          ...
          <div class="trust-indicators">
            <div class="trust-grid" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(180px, 1fr)); gap: 1.5rem;">
              ...
              <div class="trust-item" style="display: flex; align-items: center; gap: 1rem; padding: 1rem; background: rgba(255,255,255,0.05); backdrop-filter: blur(10px); border-radius: 12px; border: 1px solid rgba(255,255,255,0.1); transition: all 0.3s ease;">
                ...
                <div class="trust-content">
                  <div class="trust-label" style="color: rgba(255,255,255,0.9); font-size: 0.95rem; font-weight: 600; line-height: 1.2;"><?php echo e(number_format($stats['users_count'] ?? 0)); ?>+ مستفيد</div>
      ...
      <div class="col-lg-6 d-none d-lg-block">
        <div class="position-relative" style="max-width:480px; margin-right:auto;">
          ...
          <div class="floating-badge badge-right">
            ...
            <div>
              <div class="fb-num">+<?php echo e(number_format($stats['articles_count'] ?? 0)); ?></div>
          ...
          <div class="floating-badge badge-bottom">
            ...
            <div>
              <div class="fb-num"><?php echo e(number_format($stats['videos_count'] ?? 0)); ?></div>
          ...
          <div class="hero-card">
              ...
              <div class="col-6">
                <div class="stat-block">
                  <div style="font-size:1.4rem; margin-bottom:.4rem;">
                    <i class="bi <?php echo e($s['icon']); ?>" style="color:var(--gold)"></i>
                  </div>
                  <div class="stat-num"><?php echo e(number_format($s['num'])); ?></div>
                  <div class="stat-label"><?php echo e($s['label']); ?></div>
                  <div class="stat-sub"><?php echo e($s['sub']); ?></div>
                </div>
              </div>
            ...
            <div class="text-center mt-4">
              <a href="<?php echo e(route('register')); ?>" class="btn-hero-primary" style="width:100%; justify-content:center;">
  ...
  <div class="container">
    ...
    <div class="d-flex flex-wrap justify-content-center gap-2" data-reveal data-reveal-delay="2">
      ...
      <?php $__currentLoopData = $cats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <a href="<?php echo e($cat['url']); ?>" class="cat-pill">
          <i class="bi <?php echo e($cat['icon']); ?>"></i> <?php echo e($cat['label']); ?>
...
<section class="features-section">
  <div class="container">
    ...
    <div class="row g-4">
      ...
      <div class="col-sm-6 col-lg-3" data-reveal data-reveal-delay="<?php echo e(($i % 4) + 1); ?>">
        <div class="feature-card">
          <div class="feature-icon" style="background:<?php echo e($f['bg']); ?>; box-shadow: 0 8px 24px rgba(0,0,0,.15);">
            <i class="bi <?php echo e($f['icon']); ?>"></i>
          </div>
          <div class="feature-title"><?php echo e($f['title']); ?></div>
          <div class="feature-desc"><?php echo e($f['desc']); ?></div>
        </div>
      </div>
      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="content-card">
          <div class="content-card-head">
            ...
            <div>
              ...
              <div style="font-size:.72rem; color:#9ca3af"><?php echo e($stats['videos_count'] ?? 0); ?> فيديو منشور</div>
            </div>
          </div>
          <div class="content-card-body">
            <?php $__empty_1 = true; $__currentLoopData = ($featuredVideos ?? collect())->take(4); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $video): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <a href="<?php echo e(route('videos.show', $video->slug)); ?>" class="content-item">
              <span class="content-item-dot" style="background:var(--teal)"></span>
              <div>
                <div class="content-item-title"><?php echo e(Str::limit($video->title, 55)); ?></div>
                <div class="content-item-date">
                  <i class="bi bi-clock"></i>
                  <?php if($video->duration): ?> <?php echo e(gmdate('i:s', $video->duration)); ?> · <?php endif; ?>
          ...
          <div class="content-card-foot">
            <a href="<?php echo e(route('videos')); ?>" class="content-more">
        ...
        <div class="content-card">
          <div class="content-card-head">
            ...
            <div>
              ...
              <div style="font-size:.72rem; color:#9ca3af"><?php echo e($stats['articles_count'] ?? 0); ?> مقال منشور</div>
            </div>
          </div>
          <div class="content-card-body">
            <?php $__empty_1 = true; $__currentLoopData = ($featuredArticles ?? collect())->take(4); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $article): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <a href="<?php echo e(route('articles.show', $article->slug)); ?>" class="content-item">
              <span class="content-item-dot"></span>
              <div>
                <div class="content-item-title"><?php echo e(Str::limit($article->title, 55)); ?></div>
                <div class="content-item-date">
                  <i class="bi bi-calendar3"></i> <?php echo e($article->created_at->format('d M Y')); ?>

                  <?php if($article->author): ?> · <?php echo e($article->author->first_name); ?> <?php endif; ?>
                </div>
              </div>
            </a>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
          ...
          <div class="content-card-foot">
            <a href="<?php echo e(route('articles')); ?>" class="content-more">
        ...
        <div class="content-card">
          <div class="content-card-head">
            ...
            <div>
              ...
              <div style="font-size:.72rem; color:#9ca3af"><?php echo e($stats['books_count'] ?? 0); ?> كتاب متاح</div>
            </div>
          </div>
          <div class="content-card-body">
            <?php $__empty_1 = true; $__currentLoopData = ($featuredBooks ?? collect())->take(4); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $book): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <a href="<?php echo e(route('books.show', $book->slug)); ?>" class="content-item">
              <span class="content-item-dot" style="background:var(--gold2)"></span>
              <div>
                <div class="content-item-title"><?php echo e(Str::limit($book->title, 55)); ?></div>
                <div class="content-item-date">
                  <i class="bi bi-person"></i> <?php echo e($book->author_name); ?>

                  <?php if($book->pages): ?> · <?php echo e($book->pages); ?> صفحة <?php endif; ?>
                </div>
              </div>
            </a>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
          ...
          <div class="content-card-foot">
            <a href="<?php echo e(route('books')); ?>" class="content-more">
...
<section class="sections-zone">
  <div class="container">
    ...
    <div class="row g-3">
      ...
      <?php $__currentLoopData = $tiles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <div class="col-6 col-sm-4 col-lg-2-4" data-reveal data-reveal-delay="<?php echo e(($i % 5) + 1); ?>" style="flex:0 0 auto; width: calc(100% / <?php echo e(count($tiles) <= 5 ? count($tiles) : 4); ?>)">
        <a href="<?php echo e($t['url']); ?>" class="section-tile">
          <div class="tile-icon-wrap" style="background:<?php echo e($t['bg']); ?>">
            <i class="bi <?php echo e($t['icon']); ?> tile-icon"></i>
          </div>
          <div class="tile-name"><?php echo e($t['name']); ?></div>
          <div class="tile-desc"><?php echo e($t['desc']); ?></div>
        </a>
      </div>
      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    ...
    <div class="row justify-content-center">
      <div class="col-lg-8 text-center" data-reveal>
        ...
        <p style="color:rgba(255,255,255,.65); font-size:1.05rem; margin-bottom:2.5rem; max-width:500px; margin-right:auto; margin-left:auto;">
          أكثر من <?php echo e(number_format($stats['users_count'] ?? 0)); ?> مستفيد يتعلمون العادات الصحية. انضم الآن وابدأ رحلتك نحو حياة صحية وسليمة.
        </p>

        <div class="d-flex flex-wrap gap-3 justify-content-center">
          <?php if(auth()->guard()->guest()): ?>
          <a href="<?php echo e(route('register')); ?>" class="btn-cta-main">
            <i class="bi bi-person-plus-fill"></i> إنشاء حساب مجاني
          </a>
          <a href="<?php echo e(route('login')); ?>" class="btn-cta-ghost">
            <i class="bi bi-box-arrow-in-right"></i> تسجيل الدخول
          </a>
          <?php else: ?>
          <a href="<?php echo e(route('sections')); ?>" class="btn-cta-main">
            <i class="bi bi-compass-fill"></i> تصفح الأقسام
          </a>
          <a href="<?php echo e(route('journey')); ?>" class="btn-cta-ghost">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\saieed\وعي\resources\views\pages\home.blade.php ENDPATH**/ ?>