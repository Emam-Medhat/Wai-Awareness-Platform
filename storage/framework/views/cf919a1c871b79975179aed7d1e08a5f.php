...
<div class="container mx-auto px-4 py-8">
    ...
    <nav class="flex mb-8" aria-label="Breadcrumb">
        <ol class="flex items-center space-x-2 space-x-reverse text-sm">
            <li>
                <a href="<?php echo e(route('home')); ?>" class="text-gray-500 hover:text-primary transition">الرئيسية</a>
            </li>
            <li>
                <span class="text-gray-400">/</span>
            </li>
            <li>
                <a href="<?php echo e(route('videos')); ?>" class="text-gray-500 hover:text-primary transition">الفيديوهات</a>
            </li>
            <li>
                <span class="text-gray-400">/</span>
            </li>
            <li class="text-gray-800 font-medium"><?php echo e($video->title); ?></li>
        </ol>
    </nav>
    ...
    <div class="bg-white rounded-2xl shadow-lg overflow-hidden mb-8" data-aos="fade-up" data-aos-duration="1000">
        <div class="relative aspect-video bg-black">
            ...
            <div class="absolute bottom-0 right-0 left-0 bg-gradient-to-t from-black/80 to-transparent p-6">
                <h1 class="text-2xl md:text-3xl font-bold text-white mb-2"><?php echo e($video->title); ?></h1>
                <div class="flex items-center space-x-6 space-x-reverse text-white text-sm">
                    <div class="flex items-center">
                        <i class="fas fa-eye ml-2"></i>
                        <?php echo e($video->formatted_views); ?> مشاهدة
                    </div>
                    <div class="flex items-center">
                    ...
                    <div class="flex items-center">
                        ...
                        <?php echo e($video->published_at->format('d M Y')); ?>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2">
            ...
            <div class="bg-white rounded-2xl shadow-lg p-8 mb-8" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="100">
                ...
                <div class="flex items-center justify-between pb-6 border-b border-gray-200 mb-6">
                    <div class="flex items-center space-x-4 space-x-reverse">
                        <img src="<?php echo e($video->speaker_avatar_url); ?>" alt="<?php echo e($video->speaker_name); ?>" class="w-12 h-12 rounded-full">
                        <div>
                            <h3 class="font-semibold text-lg"><?php echo e($video->speaker_name); ?></h3>
                            <p class="text-gray-600"><?php echo e($video->speaker_title); ?></p>
                        </div>
                    </div>
                    <div class="flex items-center space-x-4 space-x-reverse">
                        <button class="flex items-center text-gray-600 hover:text-red-500 transition">
                            <i class="fas fa-heart ml-2"></i>
                            <span><?php echo e($video->likes_count ?? 0); ?></span>
                        </button>
                ...
                <div class="prose prose-lg max-w-none text-gray-700 leading-relaxed">
                    ...
                    <?php if($video->transcript): ?>
                        <h3 class="text-xl font-semibold mb-4 mt-8">النص الكامل</h3>
                        <div class="bg-gray-50 rounded-lg p-6">
                            <p class="whitespace-pre-line"><?php echo e($video->transcript); ?></p>
                        </div>
                    <?php endif; ?>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl shadow-lg p-8" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="200">
                <h3 class="text-2xl font-bold mb-6">التعليقات (<?php echo e($video->comments_count ?? 0); ?>)</h3>
        ...
        <div class="lg:col-span-1">
                    ...
                    <?php for($i = 1; $i <= 3; $i++): ?>
                        <div class="flex space-x-4 space-x-reverse cursor-pointer group">
                            <div class="relative w-32 h-20 rounded-lg overflow-hidden">
                                <img src="https://picsum.photos/seed/video<?php echo e($i); ?>/128/80.jpg" alt="Related Video" class="w-full h-full object-cover group-hover:scale-105 transition">
                            ...
                            <div class="flex-1">
                                <h4 class="font-semibold text-gray-800 group-hover:text-primary transition line-clamp-2">
                                    فيديو ذو صلة <?php echo e($i); ?>

                                </h4>
                                <p class="text-sm text-gray-500 mt-1">
                                    <i class="fas fa-clock ml-1"></i>
                                    <?php echo e(rand(5, 30)); ?> دقيقة
                                </p>
                            </div>
                        </div>
                    <?php endfor; ?>
            ...
            <div class="bg-white rounded-2xl shadow-lg p-6 mb-8" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="400">
                ...
                <div class="space-y-2">
                    <a href="<?php echo e(route('videos', ['category' => 'psychology'])); ?>" class="flex items-center justify-between p-3 rounded-lg hover:bg-gray-50 transition">
                    ...
                    <a href="<?php echo e(route('videos', ['category' => 'addiction'])); ?>" class="flex items-center justify-between p-3 rounded-lg hover:bg-gray-50 transition">
                        <span class="flex items-center">
                    ...
                    <a href="<?php echo e(route('videos', ['category' => 'relationships'])); ?>" class="flex items-center justify-between p-3 rounded-lg hover:bg-gray-50 transition">
                        <span class="flex items-center">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\saieed\وعي\resources\views\videos\show.blade.php ENDPATH**/ ?>