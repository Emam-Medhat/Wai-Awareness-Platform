...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'منصة وعي'); ?> - منصة توعوية حكومية</title>
        ...
        <div class="auth-card w-full max-w-6xl mx-auto relative z-10" data-aos="fade-up" data-aos-duration="1000">
            ...
            <div class="text-center mb-8">
                ...
                <h2 class="text-3xl font-bold text-gray-700 mb-3">
                    <?php echo $__env->yieldContent('auth-title', 'مرحباً بك!'); ?>
                </h2>
                <p class="text-xl text-gray-600 font-medium">
                    <?php echo $__env->yieldContent('auth-subtitle', 'منصة توعوية حكومية متكاملة'); ?>
                </p>
            </div>
...
<?php /**PATH D:\saieed\وعي\resources\views\layouts\auth.blade.php ENDPATH**/ ?>