...
<?php $__env->startSection('auth-title', 'مرحباً بعودتك!'); ?>
<?php $__env->startSection('auth-subtitle', 'قم بتسجيل الدخول لحسابك'); ?>
...
unset($__errorArgs, $__bag); ?>
    ...
    <div class="flex items-center justify-between">
        ...
        <div class="text-sm">
            <a href="<?php echo e(route('password.request')); ?>" class="font-medium text-primary hover:text-primary-700 transition">
                نسيت كلمة المرور؟
            </a>
        </div>
    </div>
...
<?php $__env->startSection('auth-footer'); ?>
    <span class="text-gray-600">
        ليس لديك حساب؟
        <a href="<?php echo e(route('register')); ?>" class="font-medium text-primary hover:text-primary-700 transition">
            إنشاء حساب جديد
        </a>
    </span>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.auth', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\saieed\وعي\resources\views\auth\login.blade.php ENDPATH**/ ?>