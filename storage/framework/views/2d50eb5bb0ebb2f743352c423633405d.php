...
<div class="container mb-5">
  <div class="add-book-container">
    <form method="POST" action="<?php echo e(route('books.store')); ?>" enctype="multipart/form-data" id="addBookForm">
      <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="text-center mt-4">
          ...
          <a href="<?php echo e(route('books')); ?>" class="btn btn-cancel btn-lg">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\saieed\وعي\resources\views\books\create.blade.php ENDPATH**/ ?>