<?php $__env->startSection('title', 'رحلة التغيير'); ?>
...
<section id="stages" class="journey-stages">
  <div class="stages-container">
    ...
    <div class="stages-timeline">
      ...
      <div class="stage-card" data-reveal data-reveal-delay="<?php echo e($index + 1); ?>">
        <div class="stage-number"><?php echo e($stage['id']); ?></div>
        <div class="stage-icon">
          <i class="bi <?php echo e($stage['icon']); ?>"></i>
        </div>
        ...
        <div class="stage-duration">
          ...
          <span><?php echo e($stage['duration']); ?></span>
        </div>
        <div class="stage-status <?php if($stage['completed']): ?> completed <?php elseif($index === 0): ?> current <?php else: ?> pending <?php endif; ?>">
...
<section class="progress-sec">
  <div class="progress-container">
    ...
    <div class="progress-stats" data-reveal data-reveal-delay="1">
      <div class="stat-card">
        <div class="stat-number"><?php echo e(collect($stages)->where('completed', true)->count()); ?></div>
        <div class="stat-label">مراحل مكتملة</div>
      </div>
      <div class="stat-card">
        <div class="stat-number"><?php echo e(collect($stages)->where('completed', false)->count()); ?></div>
        <div class="stat-label">مراحل متبقية</div>
      </div>
      <div class="stat-card">
        <div class="stat-number"><?php echo e(round((collect($stages)->where('completed', true)->count() / collect($stages)->count()) * 100)); ?>%</div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\saieed\وعي\resources\views\pages\journey.blade.php ENDPATH**/ ?>