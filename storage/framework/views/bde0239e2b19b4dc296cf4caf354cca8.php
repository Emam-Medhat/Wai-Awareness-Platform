<?php $__env->startSection('title', 'تسجيل حساب جديد'); ?>
    ...
    <div class="max-w-md w-full space-y-8">
        <div>
            ...
            <p class="mt-2 text-center text-sm text-gray-600">
                أو
                <a href="<?php echo e(route('login')); ?>" class="font-medium text-primary hover:text-secondary">
                    تسجيل الدخول
                </a>
            </p>
        </div>
        
        <form class="mt-8" action="<?php echo e(route('register.post')); ?>" method="POST">
            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\saieed\وعي\resources\views\auth\register-old.blade.php ENDPATH**/ ?>