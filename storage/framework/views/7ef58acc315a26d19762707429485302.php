<?php $__env->startSection('title', 'القصص'); ?>
...
<section class="content-sec">
  <div class="content-container">
    ...
    <div class="stories-grid">
      <?php $__currentLoopData = $stories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $story): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <div class="story-card" data-reveal data-reveal-delay="<?php echo e($index + 1); ?>">
        <div class="story-header">
          <div class="story-avatar">
            <?php if($story->author_avatar): ?>
              <img src="<?php echo e(asset('storage/' . $story->author_avatar)); ?>" alt="<?php echo e($story->author_name); ?>">
            <?php else: ?>
          ...
          <div class="story-author">
            <div class="story-name">
              <?php echo e($story->is_anonymous ? 'مجهول' : $story->author_name); ?>

            </div>
            <div class="story-meta">
              <div class="story-city">
                <i class="bi bi-geo-alt"></i>
                <span><?php echo e($story->author_city); ?></span>
              </div>
              <?php if($story->is_anonymous): ?>
        ...
        <div class="story-content">
          <p class="story-text"><?php echo e($story->content); ?></p>
        </div>
        <div class="story-actions">
          <div class="story-date">
            <i class="bi bi-clock"></i>
            <span><?php echo e($story->created_at->format('Y-m-d')); ?></span>
          </div>
          <div class="story-actions-buttons">
            <div class="story-likes">
              <i class="bi bi-heart"></i>
              <span><?php echo e($story->likes ?? 0); ?></span>
            </div>
            <div class="story-shares">
              <i class="bi bi-share"></i>
              <span><?php echo e($story->shares ?? 0); ?></span>
            </div>
          </div>
        </div>
      </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\saieed\وعي\resources\views\stories\index.blade.php ENDPATH**/ ?>