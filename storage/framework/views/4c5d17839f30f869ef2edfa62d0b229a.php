                            ...
                            <div class="row g-3">
                                <div class="col-md-4">
                                    <div class="content-item" style="display: flex; flex-direction: column; align-items: center; text-align: center; padding: 1.5rem; background: rgba(255,255,255,0.8); border-radius: 16px; border: 1px solid rgba(0,0,0,0.05); transition: all 0.3s ease;">
                                        ...
                                        <a href="<?php echo e(route('books')); ?>" class="btn-link" style="color: var(--accent); text-decoration: none; font-weight: 600;">
                                ...
                                <div class="col-md-4">
                                    <div class="content-item" style="display: flex; flex-direction: column; align-items: center; text-align: center; padding: 1.5rem; background: rgba(255,255,255,0.8); border-radius: 16px; border: 1px solid rgba(0,0,0,0.05); transition: all 0.3s ease;">
                                        ...
                                        <a href="<?php echo e(route('articles')); ?>" class="btn-link" style="color: var(--g2); text-decoration: none; font-weight: 600;">
                                            استكشف <i class="bi bi-arrow-left ms-1"></i>
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="content-item" style="display: flex; flex-direction: column; align-items: center; text-align: center; padding: 1.5rem; background: rgba(255,255,255,0.8); border-radius: 16px; border: 1px solid rgba(0,0,0,0.05); transition: all 0.3s ease;">
                                        ...
                                        <a href="<?php echo e(route('videos')); ?>" class="btn-link" style="color: var(--gold); text-decoration: none; font-weight: 600;">
                                            استكشف <i class="bi bi-arrow-left ms-1"></i>
                                        </a>
                                    </div>
                                </div>
                            ...
                            <div class="row g-3">
                                <div class="col-md-6">
                                    <div class="content-item" style="display: flex; flex-direction: column; align-items: center; text-align: center; padding: 1.5rem; background: rgba(255,255,255,0.8); border-radius: 16px; border: 1px solid rgba(0,0,0,0.05); transition: all 0.3s ease;">
                                        ...
                                        <a href="<?php echo e(route('stories.index')); ?>" class="btn-link" style="color: var(--gold); text-decoration: none; font-weight: 600;">
                                ...
                                <div class="col-md-6">
                                    <div class="content-item" style="display: flex; flex-direction: column; align-items: center; text-align: center; padding: 1.5rem; background: rgba(255,255,255,0.8); border-radius: 16px; border: 1px solid rgba(0,0,0,0.05); transition: all 0.3s ease;">
                                        ...
                                        <a href="<?php echo e(route('habits.index')); ?>" class="btn-link" style="color: var(--accent); text-decoration: none; font-weight: 600;">
                    ...
                    <div class="row g-4">
                        <div class="col-md-4">
                            <div class="tool-card text-center" style="padding: 2rem; background: rgba(255,255,255,0.8); border-radius: 20px; border: 1px solid rgba(0,0,0,0.05); transition: all 0.3s ease;">
                                ...
                                <a href="<?php echo e(route('ai-assistant')); ?>" class="btn-primary-action" style="display: inline-flex; align-items: center; gap: 0.5rem; padding: 0.75rem 1.5rem; background: linear-gradient(135deg, var(--accent), var(--accent-dark)); border: none; border-radius: 50px; color: white; font-weight: 600; text-decoration: none; transition: all 0.3s ease;">
                                    ابدأ المحادثة
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="tool-card text-center" style="padding: 2rem; background: rgba(255,255,255,0.8); border-radius: 20px; border: 1px solid rgba(0,0,0,0.05); transition: all 0.3s ease;">
                                ...
                                <a href="<?php echo e(route('future-message.index')); ?>" class="btn-secondary-action" style="display: inline-flex; align-items: center; gap: 0.5rem; padding: 0.75rem 1.5rem; background: linear-gradient(135deg, var(--g2), var(--g3)); border: none; border-radius: 50px; color: white; font-weight: 600; text-decoration: none; transition: all 0.3s ease;">
                                    اكتب رسالة
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="tool-card text-center" style="padding: 2rem; background: rgba(255,255,255,0.8); border-radius: 20px; border: 1px solid rgba(0,0,0,0.05); transition: all 0.3s ease;">
                                ...
                                <a href="<?php echo e(route('journey')); ?>" class="btn-tertiary-action" style="display: inline-flex; align-items: center; gap: 0.5rem; padding: 0.75rem 1.5rem; background: linear-gradient(135deg, var(--gold), #a8885e); border: none; border-radius: 50px; color: white; font-weight: 600; text-decoration: none; transition: all 0.3s ease;">
                                    عرض رحلتك
                                </a>
                            </div>
                        </div>
                    ...
                    <div class="row g-4">
                        <div class="col-md-6">
                            <div class="support-card text-center" style="padding: 2rem; background: rgba(255,255,255,0.8); border-radius: 20px; border: 1px solid rgba(0,0,0,0.05); transition: all 0.3s ease;">
                                ...
                                <a href="<?php echo e(route('contact')); ?>" class="btn-primary-action" style="display: inline-flex; align-items: center; gap: 0.5rem; padding: 0.75rem 1.5rem; background: linear-gradient(135deg, var(--accent), var(--accent-dark)); border: none; border-radius: 50px; color: white; font-weight: 600; text-decoration: none; transition: all 0.3s ease;">
                                    تواصل الآن
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="support-card text-center" style="padding: 2rem; background: rgba(255,255,255,0.8); border-radius: 20px; border: 1px solid rgba(0,0,0,0.05); transition: all 0.3s ease;">
                                ...
                                <a href="<?php echo e(route('about')); ?>" class="btn-secondary-action" style="display: inline-flex; align-items: center; gap: 0.5rem; padding: 0.75rem 1.5rem; background: linear-gradient(135deg, var(--g2), var(--g3)); border: none; border-radius: 50px; color: white; font-weight: 600; text-decoration: none; transition: all 0.3s ease;">
                                    تعرف علينا
                                </a>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\saieed\وعي\resources\views\pages\sections.blade.php ENDPATH**/ ?>