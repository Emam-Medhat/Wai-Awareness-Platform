<?php $__env->startSection('title', 'تعديل الفئة'); ?>
        ...
        <div class="col-lg-8 mx-auto">
            ...
            <div class="d-flex align-items-center justify-content-between mb-4">
                <div>
                    ...
                    <p class="text-muted">تعديل بيانات الفئة: <?php echo e($category->name); ?></p>
                </div>
...
unset($__errorArgs, $__bag); ?>" 
                                      ...
                                      name="description" 
                                      rows="3"
                                      placeholder="وصف مختصر عن الفئة ومحتواها"><?php echo e(old('description', $category->description)); ?></textarea>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group">
                                <span class="input-group-text">
                                    <i id="icon-preview" class="<?php echo e($category->icon ?? 'fas fa-book'); ?>"></i>
                                </span>
                                <input type="text" 
...
unset($__errorArgs, $__bag); ?>" 
                                       id="color" 
                                       name="color" 
                                       value="<?php echo e(old('color', $category->color ?? '#2D5E3A')); ?>"
                                       style="width: 60px;">
                                <input type="text" 
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="alert alert-info mb-4">
                            ...
                            <strong>معلومات:</strong> هذه الفئة تحتوي على <?php echo e(\App\Models\Book::where('category', $category->slug)->count()); ?> كتاب
                            <?php if(\App\Models\Book::where('category', $category->slug)->count() > 0): ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\saieed\وعي\resources\views\admin\categories\edit.blade.php ENDPATH**/ ?>