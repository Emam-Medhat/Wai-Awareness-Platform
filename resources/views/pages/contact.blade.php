  ...
  <div class="container position-relative" style="z-index:2;padding:5rem 1.5rem 4.5rem">
    <div style="max-width:650px;margin:0 auto;text-align:center">
      ...
      <div class="cp-chips" style="display:flex;flex-wrap:wrap;gap:.7rem;justify-content:center">
        @php $hChips=[['i'=>'bi-envelope-fill','n'=>'info@wa3y.gov.sa','l'=>'البريد الرسمي'],['i'=>'bi-telephone-fill','n'=>'920000000','l'=>'الهاتف الرئيسي'],['i'=>'bi-clock-fill','n'=>'أحد – خميس','l'=>'8:00 ص – 4:00 م']] @endphp
        @foreach($hChips as $hc)
        <div class="cp-chip">
          <div class="cp-chip-ico"><i class="bi {{ $hc['i'] }}"></i></div>
          <div><div class="cp-chip-n">{{ $hc['n'] }}</div><div class="cp-chip-l">{{ $hc['l'] }}</div></div>
        </div>
        @endforeach
      </div>
    </div>
...
<section class="why-sec">
  <div class="container">
    ...
    <div class="row g-4">
      ...
      <div class="col-sm-6 col-lg-3" data-sr="up" data-sr-d="{{ $wi+1 }}">
        <div class="why-card">
          <div class="why-ico" style="background:{{ $w['bg'] }}"><i class="bi {{ $w['i'] }}"></i></div>
          <div class="why-title">{{ $w['t'] }}</div>
          <div class="why-sub">{{ $w['s'] }}</div>
        </div>
      </div>
      @endforeach
    </div>
...
<section class="team-sec">
  <div class="container">
    ...
    <div class="row g-4">
      ...
      <div class="col-md-4" data-sr="up" data-sr-d="{{ $ti+1 }}">
        <div class="team-card">
          <div class="team-av" style="background:{{ $tm['bg'] }}"><i class="bi {{ $tm['av'] }}"></i></div>
          <div class="team-name">{{ $tm['n'] }}</div>
          <div class="team-role">{{ $tm['r'] }}</div>
          <div class="team-bio">{{ $tm['b'] }}</div>
          <div class="team-stats">
            <div><div class="team-stat-n">{{ $tm['s1'] }}</div><div class="team-stat-l">{{ $tm['l1'] }}</div></div>
            <div style="width:1px;background:var(--bd)"></div>
            <div><div class="team-stat-n">{{ $tm['s2'] }}</div><div class="team-stat-l">{{ $tm['l2'] }}</div></div>
          </div>
        </div>
      </div>
      @endforeach
...
<section class="srv-sec">
  <div class="container">
    ...
    <div class="row g-3">
      ...
      @foreach($srvs as $si=>$srv)
      <div class="col-md-6" data-sr="up" data-sr-d="{{ ($si%2)+1 }}">
        <div class="srv-card">
          <div class="srv-ico" style="background:{{ $srv['bg'] }}"><i class="bi {{ $srv['i'] }}"></i></div>
          <div style="flex:1">
            <div class="srv-title">{{ $srv['t'] }}</div>
            <div class="srv-sub">{{ $srv['s'] }}</div>
            <div class="srv-tags">
              @foreach($srv['tags'] as $tag)
              <span class="srv-tag" style="background:{{ $tag[1] }};color:{{ $tag[2] }}">{{ $tag[0] }}</span>
              @endforeach
            </div>
          </div>
        </div>
      ...
      <div data-sr="up">
        <div class="cp-card">
          ...
          <div class="cp-card-body">
            @if(session('success'))
            <div class="f-success"><i class="bi bi-check-circle-fill"></i> {{ session('success') }}</div>
            @endif
              ...
              <div class="row g-3">
                <div class="col-md-6">
                  <div class="f-group">
                    ...
                    <input type="text" name="name" class="f-input" value="{{ old('name') }}" placeholder="أدخل اسمك الكامل" required></div>
                    @error('name')<div class="f-err"><i class="bi bi-exclamation-circle" style="font-size:.65rem"></i>{{ $message }}</div>@enderror
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="f-group">
                    ...
                    <input type="email" name="email" class="f-input" value="{{ old('email') }}" placeholder="example@email.com" required></div>
                    @error('email')<div class="f-err"><i class="bi bi-exclamation-circle" style="font-size:.65rem"></i>{{ $message }}</div>@enderror
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="f-group">
                    ...
                    <input type="tel" name="phone" class="f-input" value="{{ old('phone') }}" placeholder="05xxxxxxxx"></div>
                    @error('phone')<div class="f-err"><i class="bi bi-exclamation-circle" style="font-size:.65rem"></i>{{ $message }}</div>@enderror
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="f-group">
                    ...
                    <input type="text" name="subject" class="f-input" value="{{ old('subject') }}" placeholder="موضوع الرسالة" required></div>
                    @error('subject')<div class="f-err"><i class="bi bi-exclamation-circle" style="font-size:.65rem"></i>{{ $message }}</div>@enderror
                  </div>
                </div>
                <div class="col-12">
                  <div class="f-group" style="margin-bottom:.2rem">
                    <label class="f-label"><span class="f-req">*</span>الرسالة</label>
                    <textarea name="message" class="f-input f-ta" placeholder="اكتب رسالتك بالتفصيل..." required>{{ old('message') }}</textarea>
                    @error('message')<div class="f-err"><i class="bi bi-exclamation-circle" style="font-size:.65rem"></i>{{ $message }}</div>@enderror
                  </div>
                </div>
                <div class="col-12">
...
<section class="faq-sec">
  <div class="container">
    ...
    <div class="faq-grid">
      ...
      <div class="faq-item" data-sr="up" data-sr-d="{{ ($fi%4)+1 }}">
        <div style="display:flex;align-items:flex-start;gap:.9rem">
          <div class="faq-ico" style="background:{{ $fq['bg'] }};color:#fff"><i class="bi {{ $fq['i'] }}"></i></div>
          <div><div class="faq-q">{{ $fq['q'] }}</div><div class="faq-a">{{ $fq['a'] }}</div></div>
        </div>
      </div>
      @endforeach
    </div>
