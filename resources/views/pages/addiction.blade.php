...
<section class="content-sec">
  <div class="content-container">
    ...
    <div class="articles-grid">
      ...
      <div class="article-card" data-reveal data-reveal-delay="{{ $index + 1 }}">
        ...
        <div class="article-content">
          ...
          <p class="article-desc">{{ Str::limit($article->content, 150) }}</p>
          <div class="article-meta">
            <div class="article-author">
              <i class="bi bi-person"></i>
              <span>{{ $article->author ?? 'دكتور متخصص' }}</span>
            </div>
...
<section class="content-sec">
  <div class="content-container">
    ...
    <div class="videos-grid">
      ...
      <div class="video-card" data-reveal data-reveal-delay="{{ $index + 1 }}">
        ...
        <div class="video-content">
          ...
          <p class="video-desc">{{ Str::limit($video->description, 120) }}</p>
          <div class="video-meta">
            <div class="video-views">
              <i class="bi bi-eye"></i>
              <span>{{ number_format($video->views ?? 0) }} مشاهدة</span>
            </div>
...
<section class="content-sec">
  <div class="content-container">
    ...
    <div class="books-grid">
      ...
      <div class="book-card" data-reveal data-reveal-delay="{{ $index + 1 }}">
        ...
        <div class="book-content">
          ...
          <div class="book-author">{{ $book->author ?? 'مؤلف متخصص' }}</div>
          <p class="book-desc">{{ Str::limit($book->description, 120) }}</p>
          <div class="book-rating">
            <div class="book-stars">
              @for($i = 1; $i <= 5; $i++)
                <i class="bi bi-star{{ $i <= ($book->rating ?? 4) ? '-fill' : '' }}"></i>
              @endfor
            </div>
            <div class="book-rating-text">{{ $book->rating ?? 4.5 }} ({{ $book->reviews_count ?? 120 }} تقييم)</div>
          </div>
  ...
  <div class="help-container">
    ...
    <div class="help-card" data-reveal data-reveal-delay="1">
      ...
      <div class="help-buttons">
        ...
        <a href="{{ route('contact') }}" class="help-btn-secondary">
          <i class="bi bi-envelope me-2"></i>
          راسلنا
        </a>
        <a href="{{ route('ai-assistant') }}" class="help-btn-secondary">
