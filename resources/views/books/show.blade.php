      ...
      <div class="col-lg-8">
        <div class="book-info">
          ...
          <div class="book-meta">
            ...
            @if($book->author_title)
            <div class="meta-item">
              <div class="meta-icon">
                <i class="bi bi-award"></i>
              </div>
              <span>{{ $book->author_title }}</span>
            </div>
            @endif
            ...
            <div class="meta-item">
              ...
              <span>{{ $book->category_label ?? $book->category }}</span>
            </div>
            ...
            <div class="meta-item">
              ...
              <span>{{ $book->publication_date->format('Y/m/d') }}</span>
            </div>
            @endif
          ...
          <div class="action-buttons">
            @if($book->pdf_file)
              <a href="{{ route('books.download', $book->slug) }}" 
                 class="btn-download"
                 onclick="console.log('Download clicked, URL:', '{{ route('books.download', $book->slug) }}'); return true;">
            ...
            <a href="{{ route('books') }}" class="btn-back">
    ...
    <div class="col-lg-4">
      ...
      <div class="content-section">
        ...
        <div class="stats-grid">
          <div class="stat-item">
            <div class="stat-value">{{ $book->formatted_views }}</div>
            <div class="stat-label">المشاهدات</div>
          </div>
          <div class="stat-item">
            <div class="stat-value">{{ $book->formatted_download_count }}</div>
          ...
          <div class="stat-item">
            <div class="stat-value">{{ $book->file_size_label ?? '-' }}</div>
      ...
      <div class="content-section">
        ...
        <div class="related-books">
          @foreach($relatedBooks as $relatedBook)
            <a href="{{ route('books.show', $relatedBook->slug) }}" class="related-book">
              <div class="related-book-cover">
                @if($relatedBook->cover_image)
                  <img src="{{ $relatedBook->cover_image_url }}" alt="{{ $relatedBook->title }}" style="width: 100%; height: 100%; object-fit: cover; border-radius: 8px;">
                @else
                  <i class="bi bi-book"></i>
                @endif
              </div>
