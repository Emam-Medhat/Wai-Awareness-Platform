...
<section class="content-sec">
  <div class="content-container">
    ...
    <div class="habits-grid">
      ...
      <div class="habit-card" data-reveal data-reveal-delay="{{ $index + 1 }}">
        <div class="habit-header">
          <div class="habit-avatar">
            @if($habit->author_avatar)
              <img src="{{ asset('storage/' . $habit->author_avatar) }}" alt="{{ $habit->author_name }}">
            @else
              <i class="bi bi-person"></i>
            @endif
          </div>
          <div class="habit-author">
            <div class="habit-name">{{ $habit->author_name }}</div>
            <div class="habit-meta">
              <div class="habit-city">
                <i class="bi bi-geo-alt"></i>
                <span>{{ $habit->author_city }}</span>
              </div>
              @if($habit->author_age)
              <div class="habit-age">
                <i class="bi bi-calendar"></i>
                <span>{{ $habit->author_age }} سنة</span>
              </div>
              @endif
            </div>
          </div>
        ...
        <div class="habit-content">
          <p class="habit-text">{{ $habit->content }}</p>
        </div>
        <div class="habit-actions">
          <div class="habit-date">
            <i class="bi bi-clock"></i>
            <span>{{ $habit->created_at->format('Y-m-d') }}</span>
          </div>
