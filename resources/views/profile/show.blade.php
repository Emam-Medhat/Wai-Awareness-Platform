            ...
            <div class="col-lg-4">
                ...
                <div class="card border-0 shadow-xl mb-4 profile-card" style="background: rgba(255,255,255,0.98); backdrop-filter: blur(20px); border-radius: 24px; overflow: hidden; position: relative;">
                    ...
                    <div class="card-body text-center p-4" style="position: relative; z-index:1;">
                        ...
                        <!-- User Info -->
                        <h2 class="mb-2 fw-bold" style="color: var(--dark); font-size: 1.8rem;">{{ $user->name }}</h2>
                        <p class="text-muted mb-3" style="font-size: 1.1rem;">{{ $user->email }}</p>
                        ...
                        <div class="join-date">
                            <div class="d-inline-flex align-items-center px-3 py-2 rounded-pill" style="background: rgba(44,95,45,0.1); border: 1px solid rgba(44,95,45,0.2);">
                                ...
                                <span class="fw-medium" style="color: var(--g2);">انضم في {{ $user->created_at->format('Y/m/d') }}</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card border-0 shadow-xl actions-card" style="background: rgba(255,255,255,0.98); backdrop-filter: blur(20px); border-radius: 24px;">
                    <div class="card-body p-4">
                        ...
                        <div class="d-grid gap-3">
                            <a href="{{ route('profile.edit') }}" class="action-btn" style="border: 2px solid var(--accent); color: var(--accent); background: rgba(233,30,99,0.05);">
                                <i class="bi bi-pencil-square me-2"></i>
                                <span>تعديل الملف الشخصي</span>
                            </a>
                            <a href="{{ route('stories.my') }}" class="action-btn" style="border: 2px solid var(--g2); color: var(--g2); background: rgba(44,95,45,0.05);">
                                <i class="bi bi-journal-text me-2"></i>
                                <span>قصصي ومقالاتي</span>
                            </a>
                            <a href="{{ route('habits.my') }}" class="action-btn" style="border: 2px solid var(--g2); color: var(--g2); background: rgba(44,95,45,0.05);">
                                <i class="bi bi-heart-pulse me-2"></i>
                                <span>عاداتي وتحدياتي</span>
                            </a>
                            <a href="{{ route('notifications') }}" class="action-btn" style="border: 2px solid #0ea5e9; color: #0ea5e9; background: rgba(14,165,233,0.05);">
        ...
        <div class="col-lg-8">
                ...
                <div class="card-body p-4">
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <p class="form-control-plaintext bg-light rounded p-3">{{ $user->name }}</p>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="form-label fw-bold" style="color: var(--dark);">
                            ...
                            <p class="form-control-plaintext bg-light rounded p-3">{{ $user->email }}</p>
                        </div>
                        @if($user->phone)
                        <div class="col-md-6 mb-3">
                            <label class="form-label fw-bold" style="color: var(--dark);">
                            ...
                            <p class="form-control-plaintext bg-light rounded p-3">{{ $user->phone }}</p>
                        </div>
                        @endif
                        @if($user->bio)
                        <div class="col-12 mb-3">
                            ...
                            <p class="form-control-plaintext bg-light rounded p-3">{{ $user->bio }}</p>
                        </div>
                        @endif
                    </div>
                    
                    <div class="mt-4">
                        <a href="{{ route('profile.edit') }}" class="btn btn-lg px-4 py-2 rounded-pill" style="background: linear-gradient(135deg, var(--accent), var(--accent-dark)); border: none; color: white; box-shadow: 0 4px 15px rgba(233,30,99,0.3); transition: all 0.3s ease;">
            ...
            <div class="card border-0 shadow-lg" style="background: rgba(255,255,255,0.95); backdrop-filter: blur(10px); border-radius: 20px;">
                ...
                <div class="card-body p-4">
                    ...
                    @if($recentStories->count() > 0 || $recentHabits->count() > 0)
                        <div class="timeline">
                                ...
                                <div class="timeline-item mb-4 p-3 rounded-3" style="background: rgba(233,30,99,0.05); border-left: 4px solid var(--accent); transition: all 0.3s ease;">
                                    <div class="d-flex">
                                        ...
                                        <div class="flex-grow-1 ms-3">
                                            ...
                                            <p class="text-muted mb-2">{{ Str::limit($story->content, 120) }}</p>
                                            <small class="text-muted" style="color: var(--accent);">
                                                <i class="bi bi-clock me-1"></i>{{ $story->created_at->diffForHumans() }}
                                            </small>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="timeline-item mb-4 p-3 rounded-3" style="background: rgba(44,95,45,0.05); border-left: 4px solid var(--g2); transition: all 0.3s ease;">
                                    <div class="d-flex">
                                        ...
                                        <div class="flex-grow-1 ms-3">
                                            ...
                                            <p class="text-muted mb-2">{{ Str::limit($habit->description, 120) }}</p>
                                            <small class="text-muted" style="color: var(--g2);">
                                                <i class="bi bi-clock me-1"></i>{{ $habit->created_at->diffForHumans() }}
                                            </small>
                                        </div>
                                    </div>
                                </div>
                    ...
                    @else
                        <div class="text-center py-5">
                            ...
                            <a href="{{ route('stories.index') }}" class="btn btn-lg px-4 py-2 rounded-pill" style="background: linear-gradient(135deg, var(--g2), var(--g3)); border: none; color: white; box-shadow: 0 4px 15px rgba(74,124,89,0.3);">
