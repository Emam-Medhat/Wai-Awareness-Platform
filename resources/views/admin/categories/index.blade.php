                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="books-count">
                                        <i class="fas fa-book"></i>
                                        {{ \App\Models\Book::where('category', $category->slug)->count() }} كتاب
                                    </span>
                                </td>
                                <td>
                                    ...
                                    <div class="action-buttons">
                                        ...
                                        @if($category->is_active)
                                            <a href="{{ route('categories.show', $category->slug) }}" 
                                               ...
                                               target="_blank"
                                               title="معاينة التصنيف: {{ $category->name }}"
                                               data-category-id="{{ $category->id }}"
                                        ...
                                        <form method="POST" 
                                              ...
                                              class="d-inline"
                                              onsubmit="return confirmCategoryDelete(event, '{{ $category->name }}', '{{ $category->books_count ?? 0 }}')">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" 
