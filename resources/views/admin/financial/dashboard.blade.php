        ...
        <div class="col-md-3">
            <div class="card bg-danger text-white">
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <div>
                            <h4 class="mb-0">{{ number_format($stats['total_expenses']) }}</h4>
        ...
        <div class="col-md-3">
            <div class="card bg-primary text-white">
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <div>
                            <h4 class="mb-0">{{ number_format($stats['net_profit']) }}</h4>
        ...
        <div class="col-md-3">
            <div class="card bg-info text-white">
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <div>
                            <h4 class="mb-0">{{ $stats['monthly_growth'] }}%</h4>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-6 mb-3">
                            <a href="{{ route('admin.financial.expenses') }}" class="btn btn-outline-danger btn-block">
                                <i class="fas fa-money-bill-wave ms-2"></i>
                                عرض النفقات
                            </a>
                        </div>
                        <div class="col-6 mb-3">
                            <a href="{{ route('admin.financial.revenue') }}" class="btn btn-outline-success btn-block">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        <div class="d-flex justify-content-between mb-1">
                            <span>الإيرادات</span>
                            <span class="text-success">{{ number_format(end($chartData['revenue'])) }}</span>
                        </div>
                    ...
                    <div class="mb-3">
                        <div class="d-flex justify-content-between mb-1">
                            <span>النفقات</span>
                            <span class="text-danger">{{ number_format(end($chartData['expenses'])) }}</span>
                        </div>
                        <div class="progress" style="height: 8px;">
                    ...
                    <div class="mb-3">
                        <div class="d-flex justify-content-between mb-1">
                            ...
                            <span class="text-primary">{{ number_format(end($chartData['profit'])) }}</span>
                        </div>
                        <div class="progress" style="height: 8px;">
