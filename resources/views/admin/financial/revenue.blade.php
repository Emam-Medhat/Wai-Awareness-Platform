            ...
            <div class="card bg-success text-white">
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <div>
                            <h4 class="mb-0">{{ number_format(array_sum(array_column($monthlyRevenue, 'amount'))) }}</h4>
        ...
        <div class="col-md-3">
            <div class="card bg-success text-white">
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <div>
                            <h4 class="mb-0">{{ number_format(end($monthlyRevenue)['amount']) }}</h4>
        ...
        <div class="col-md-3">
            <div class="card bg-info text-white">
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <div>
                            <h4 class="mb-0">{{ number_format(array_sum(array_column($monthlyRevenue, 'amount')) / count($monthlyRevenue)) }}</h4>
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="badge bg-success">{{ $transaction['type'] == 'revenue' ? 'إيراد' : 'نفقة' }}</span>
                                    </td>
                                    <td class="{{ $transaction['type'] == 'revenue' ? 'text-success' : 'text-danger' }}">
                                        {{ $transaction['type'] == 'revenue' ? '+' : '-' }}{{ number_format($transaction['amount']) }} ريال
                                    </td>
                                    <td>
...
<script>
    ...
    new Chart(revenueSourcesCtx, {
        type: 'doughnut',
        data: {
            labels: @json(array_column($revenueSources, 'name')),
            datasets: [{
                data: @json(array_column($revenueSources, 'amount')),
                backgroundColor: [
                    '#28a745',
                    '#17a2b8',
                    '#ffc107',
