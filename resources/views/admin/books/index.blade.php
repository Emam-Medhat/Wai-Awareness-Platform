    ...
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-md-4 text-end">
                <a href="{{ route('admin.books.create') }}" class="btn btn-light btn-lg">
...
<div class="row mb-4">
    ...
    <div class="col-md-3 mb-3">
        <div class="stat-card p-4 text-center">
            ...
            <div class="stat-number">{{ \App\Models\Book::where('is_published', true)->count() }}</div>
    ...
    <div class="col-md-3 mb-3">
        <div class="stat-card p-4 text-center">
            ...
            <div class="stat-number">{{ \App\Models\Book::where('is_featured', true)->count() }}</div>
    ...
    <div class="col-md-3 mb-3">
        <div class="stat-card p-4 text-center">
            ...
            <div class="stat-number">{{ number_format(\App\Models\Book::sum('views')) }}</div>
                    ...
                    <tr>
                        <td>
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    ...
                                    <small class="text-muted">{{ $book->created_at->format('Y-m-d') }}</small>
                                </div>
                            </div>
                        </td>
                        <td>
                            ...
                            @if($book->user)
                                <small class="text-muted">{{ $book->user->full_name }}</small>
                            @endif
                        </td>
                        <td>
                            @if($book->category)
                        ...
                        <td>
                            <div class="text-center">
                                <strong>{{ number_format($book->views) }}</strong>
                            </div>
                        </td>
                        <td>
